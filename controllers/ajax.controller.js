...
module.exports.like = async (req, res) => {
    ...
    // -->
    var LIKE = await CommentM.updateOne({'_id': ID_CMT}, { $push: {'like': ID_USER_LIKE}});
    console.log(LIKE);
    res.send({
        success: true,
    });
...
module.exports.unlike = async (req, res) => {
    ...
    console.log(ID_CMT + ":" + ID_POST + ":" + ID_USER_LIKE);
    // -->
    var UNLIKE = await CommentM.updateOne({'_id': ID_CMT}, { $pull: {'like': ID_USER_LIKE}});
    console.log(UNLIKE);
    res.send({
        success: true,
    });
...
module.exports.comment = async (req, res) => {
    ...
    CommentM.create({idpost: ID_POST, user: ID_USER_CMT, content: CONTENT},function(err, CommentM){
